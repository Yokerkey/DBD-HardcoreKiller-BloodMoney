            ...
            <div className="loadout-container">
                {loadoutKiller && (
                    <div className="killer-info">
                        <img src={import.meta.env.BASE_URL + "/killers/" + loadoutKiller.name + ".webp"} className="logo" alt={loadoutKiller.name} />
                ...
                <div className="perks-container">
                    {loadoutPerks.map(perk => (
                        <div key={perk.name} className="perk-item">
                            <img src={import.meta.env.BASE_URL + "/perks/" + perk.name + ".webp"} className="logo"/>
                            <p>{perk.name}</p>
                            <p>{perk.cost}$</p>
                        </div>
                    ))}
